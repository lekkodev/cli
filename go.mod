...
require (
	buf.build/gen/go/lekkodev/cli/bufbuild/connect-go v1.7.0-20230515185649-0a7c51c5d3e5.1
	buf.build/gen/go/lekkodev/cli/protocolbuffers/go v1.30.0-20230515185649-0a7c51c5d3e5.1
