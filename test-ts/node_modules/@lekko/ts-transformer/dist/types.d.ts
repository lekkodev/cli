...
export type LekkoComparisonOperator = "COMPARISON_OPERATOR_EQUALS" | "COMPARISON_OPERATOR_LESS_THAN" | "COMPARISON_OPERATOR_LESS_THAN_OR_EQUALS" | "COMPARISON_OPERATOR_GREATER_THAN" | "COMPARISON_OPERATOR_GREATER_THAN_OR_EQUALS" | "COMPARISON_OPERATOR_NOT_EQUALS" | "COMPARISON_OPERATOR_CONTAINS" | "COMPARISON_OPERATOR_STARTS_WITH" | "COMPARISON_OPERATOR_ENDS_WITH" | "COMPARISON_OPERATOR_PRESENT";
export type LekkoConfigType = "FEATURE_TYPE_BOOL" | "FEATURE_TYPE_STRING" | "FEATURE_TYPE_INT" | "FEATURE_TYPE_FLOAT" | "FEATURE_TYPE_JSON" | "FEATURE_TYPE_PROTO";
export type LekkoConfigTypeURL<T extends LekkoConfigType> = T extends "FEATURE_TYPE_BOOL" ? "type.googleapis.com/google.protobuf.BoolValue" : T extends "FEATURE_TYPE_BOOL" ? "type.googleapis.com/google.protobuf.StringValue" : T extends "FEATURE_TYPE_INT" ? "type.googleapis.com/google.protobuf.IntValue" : T extends "FEATURE_TYPE_FLOAT" ? "type.googleapis.com/google.protobuf.FloatValue" : T extends "FEATURE_TYPE_PROTO" ? string : never;
