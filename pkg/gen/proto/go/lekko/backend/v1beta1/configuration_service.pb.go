...
var file_lekko_backend_v1beta1_configuration_service_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
func file_lekko_backend_v1beta1_configuration_service_proto_init() {
	...
	file_lekko_backend_v1beta1_configuration_service_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*Value_BoolValue)(nil),
		(*Value_IntValue)(nil),
