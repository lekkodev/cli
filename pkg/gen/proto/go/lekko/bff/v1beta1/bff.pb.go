...
type DeleteRepositoryRequest struct {
	...
	RepoKey *RepositoryKey `protobuf:"bytes,1,opt,name=repo_key,json=repoKey,proto3" json:"repo_key,omitempty"`
	// If provided, this rpc will also delete the repository on github.
	// This flag should probably depend on user preference.
	DeleteOnGithub bool `protobuf:"varint,2,opt,name=delete_on_github,json=deleteOnGithub,proto3" json:"delete_on_github,omitempty"`
}
...
func (x *DeleteRepositoryRequest) GetDeleteOnGithub() bool {
	if x != nil {
		return x.DeleteOnGithub
	}
	return false
}
...
var file_lekko_bff_v1beta1_bff_proto_rawDesc = []byte{
	...
	0x28, 0x0a, 0x10, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x5f, 0x6f, 0x6e, 0x5f, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x64, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x4f, 0x6e, 0x47, 0x69, 0x74, 0x68, 0x75, 0x62, 0x22, 0x1a, 0x0a, 0x18, 0x44, 0x65, 0x6c,
